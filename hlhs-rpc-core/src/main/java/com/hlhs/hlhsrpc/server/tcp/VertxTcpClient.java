package com.hlhs.hlhsrpc.server.tcp;
...
public class VertxTcpClient {
     ...
     */
    public static RpcResponse doRequest(RpcRequest rpcRequest, ServicerMetaInfo serviceMetaInfo) throws InterruptedException, ExecutionException {
        // 发送 TCP 请求
